...
- Runner: Cucumber.js with `tsx/esm` for TypeScript transpilation. Tests run serially against a spawned production build of the app backed by a real MongoDB test database.

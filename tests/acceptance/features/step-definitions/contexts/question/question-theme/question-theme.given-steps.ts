...
Given(/^the database is populated with question themes fixture set with name "(?<fixtureName>[^"]+)"$/u, async function(this: GoatItWorld, fixtureName: keyof typeof FIXTURE_REGISTRY["question-theme"]): Promise<void> {

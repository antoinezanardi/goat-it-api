...
import { QUESTION_IDS_QUERY_KEY, QUESTION_IS_ADULT_CONTENT_QUERY_KEY, QUESTION_THEME_IDS_QUERY_KEY } from "@question/application/dto/shared/constants/question-filter-query.dto.constants";
...
const RANDOM_QUESTION_BODY_DATATABLE_ROW_SCHEMA = z.strictObject({
  ...
  cognitiveDifficulties: zCoerceOptionalStringArray(),
  themeIds: zCoerceOptionalStringArray(),
  isAdultContent: zCoerceOptionalBoolean(),
});

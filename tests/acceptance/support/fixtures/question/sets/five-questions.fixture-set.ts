  ...
  createFakeQuestionDocument({
    ...
    content: createFakeQuestionContentAggregate({
      ...
      trivia: createFakeLocalizedTexts({
        ...
        pt: ["O álbum permaneu nas paradas da Billboard por um número recorde de semanas."],
  ...
  createFakeQuestionDocument({
    ...
    content: createFakeQuestionContentAggregate({
      ...
      context: createFakeLocalizedText({
        ...
        es: "Francia ganó la Copa Mundial de la FIFA 2018 celebrada en Rússia, derrotando a Croacia en la final.",
  ...
  createFakeQuestionDocument({
    ...
    content: createFakeQuestionContentAggregate({
      ...
      context: createFakeLocalizedText({
        ...
        es: "Los elefantes no son ampliamente conocidos por su medo a las abejas, lo que puede parecer sorprendente dada su imponente tamanho. Sin embargo, esta fobia está bem documentada y los elefantes a menudo evitan las áreas donde hay abejas.",
      ...
      trivia: createFakeLocalizedTexts({
        ...
        pt: ["As abelhas são usadas por alguns guardas florestais per proteger os elefantes dos caçadores furtivos, pois os elefantes evitam naturalmente áreas onde as abelhas estão presentes."],

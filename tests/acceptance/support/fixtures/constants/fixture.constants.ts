...
import { TRANSLATION_COMPLETENESS_QUESTION_THEMES_FIXTURE_SET } from "@acceptance-support/fixtures/question-theme/sets/translation-completeness-question-themes.fixture-set";
...
import { TRANSLATION_COMPLETENESS_QUESTIONS_FIXTURE_SET } from "@acceptance-support/fixtures/question/sets/translation-completeness-questions.fixture-set";
...
const FIXTURE_REGISTRY: FixtureRegistry = {
  "question": {
    ...
    "translation-completeness-questions": {
      data: TRANSLATION_COMPLETENESS_QUESTIONS_FIXTURE_SET,
      dependencies: [["question-theme", "translation-completeness-question-themes"]],
    },
  },
  "question-theme": {
    ...
    "translation-completeness-question-themes": {
      data: TRANSLATION_COMPLETENESS_QUESTION_THEMES_FIXTURE_SET,
    },
  },
};

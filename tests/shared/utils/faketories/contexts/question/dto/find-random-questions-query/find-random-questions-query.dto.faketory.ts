...
import { RANDOM_QUESTIONS_LIMIT_DEFAULT, RANDOM_QUESTIONS_LIMIT_MINIMUM } from "@question/application/dto/find-random-questions-query/constants/find-random-questions-query.dto.constants";
...
function createFakeFindRandomQuestionsQueryDto(overrides: Partial<FindRandomQuestionsQueryDto> = {}): FindRandomQuestionsQueryDto {
  return {
    [LIMIT_QUERY_KEY]: faker.helpers.maybe(() => faker.number.int({ min: RANDOM_QUESTIONS_LIMIT_MINIMUM })) ?? RANDOM_QUESTIONS_LIMIT_DEFAULT,
    ...overrides,
  };
}

...
import { ADMIN_FIND_QUESTION_THEMES_SORT_QUERY_DTO } from "@question-theme/application/dto/admin-find-question-themes-sort-query/admin-find-question-themes-sort-query.dto.shape";
...
describe("Admin Find Question-Themes Sort Query DTO Shape", () => {
  ...
  it("should use both defaults when no fields are provided.", () => {
    ...
    expect(result).toStrictEqual<AdminFindQuestionThemesSortQueryDto>({ "sort-by": "slug", "sort-order": "asc" });
  });
});
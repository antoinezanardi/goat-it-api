...
describe("Build Question Aggregation Filter Stages", () => {
  ...
  it("should return a match stage with translation completeness condition when isFullyTranslated is true.", () => {
    const filters: Partial<QuestionFilterOptions> = { isFullyTranslated: true };

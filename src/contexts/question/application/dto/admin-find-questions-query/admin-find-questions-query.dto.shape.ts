...
import { zQuestionAuthorRole, zQuestionCategory, zQuestionCognitiveDifficulty, zQuestionStatus } from "@question/application/dto/shared/zod/validators/question.dto.zod.validators";
...
const ADMIN_FIND_QUESTIONS_QUERY_DTO = z.object({
  ...
  [QUESTION_THEME_IDS_QUERY_KEY]: z.array(zMongoId().describe("Theme ID to filter questions by"))
    .optional()

...
**REQUIRED BACKGROUND:** This skill adapts the RED-GREEN-REFACTOR cycle to documentation.
...
- ❌ Bad: `@skills/testing/systematic-debugging/SKILL.md` (force-loads, burns context)
...
**REQUIRED BACKGROUND:** The RED-GREEN-REFACTOR cycle principles apply to documentation.

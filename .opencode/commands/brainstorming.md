...
Explore project context, ask clarifying questions one at a time, propose approaches with trade-offs, present the design for approval, write the spec doc, then transition to implementation planning.

...
Prompt the user to describe a lesson (e.g., "Mappers should never have side effects"), then search docs for related content, propose an addition to the most relevant file, show the diff, and edit docs if the user approves.

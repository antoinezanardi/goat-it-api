...
Read the spec, check scope for subsystem splits, map out the file structure, decompose into bite-sized TDD tasks with verification steps, then save the plan and get user review.